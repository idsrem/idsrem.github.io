...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const currentMinutes = now.getHours() * 60 + minutes;
    ...
    if (surveyContainer && surveyCloseModal && containerView) {
        ...
        if (index > 1) {
            ...
            if (question.id === "mengundiAdun") {
                ...
                if (selectedDun && dunToAdun[selectedDun]) {
                    ...
                    const surveyContainer = document.getElementById("survey-container");
                    surveyContainer.style.height = "100%";
...
function showFilteredParliments(parlimen, nextIndex) {
    ...
    function showAgeInput(questionText, questionId, nextIndex) {
        ...
        submitButton.innerHTML = `<i class="fas fa-arrow-circle-right" style="color: white; margin-right: 5px;"></i> Seterusnya`;
