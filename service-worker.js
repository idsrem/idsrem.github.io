...
const CACHE_NAME = 'offline-cache-v3.6.4';  // Change the version number whenever there's an update
...
const CACHE_ASSETS = [
  ...
  'fasa2(tutup)/index.html',
  'fasa2(tutup)/styles2.css',
  'fasa2(tutup)/questions2.js'
];
